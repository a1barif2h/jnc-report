...
class TradeLicense {
  ...
  async generate(body) {
    ...
    const initialTemplate = fs.readFileSync(
      "./ejs_pdf_templates/trade-license/trade-license.ejs",
      "utf-8"
    );
    const initialHeaderTemplate = fs.readFileSync('./ejs_pdf_templates/trade-license/header-template.ejs', 'utf-8')
