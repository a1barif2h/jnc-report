...
class TechnicalKnowHowFee {
    ...
    async generate(body) {
        ...
        const initialTemplate = fs.readFileSync(
            "./ejs_pdf_templates/technical-know-how-fee/technical-know-how-fee.ejs",
            "utf-8"
        );
        const initialHeaderTemplate = fs.readFileSync('./ejs_pdf_templates/technical-know-how-fee/header-template.ejs', 'utf-8')
