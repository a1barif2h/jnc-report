...
class PartialUseOfBuilding {
  ...
  async generate(body) {
    ...
    const initialTemplate = fs.readFileSync('./ejs_pdf_templates/partial-use-of-building/partial-use-of-building.ejs', 'utf8');
    const initialHeaderTemplate = fs.readFileSync('./ejs_pdf_templates/partial-use-of-building/header-template.ejs', 'utf8');
